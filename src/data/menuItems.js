...
export const menuCategories = [
  {
    ...
    items: [
      ...
      item("hot-chocolate", "Hot Chocolate", 290, pic("menuHotChocolate.jpg"), "Warm",
      ...
      item("espresso-frappe", "Espresso Frappe", 310, pic("menuEspressoFrappe.jpg"), "Bold",
          "Chilled espresso frappe for caffeine lovers — bold, cold, and refreshingly smooth."),
      item("oreo-frappe", "Oreo Frappe", 350, pic("menuOreoFrappe.jpg"), "Crowd Favorite",
          "Crushed Oreo cookies blended into a creamy frappe — sweet, crunchy, and crowd-loved."),
      item("caramel-frappe", "Caramel Frappe", 350, pic("menuCaramelFrappe.jpg"), "Sweet",
          "Smooth caramel-blended frappe, balanced and easy-drinking with a sweet finish."),
      item("vanilla-frappe", "Vanilla Frappe", 330, pic("menuVanillaShake.jpg"), "Smooth",
          "Light and mellow vanilla-blended frappe — silky, sweet, and refreshingly cool."),
      item("french-vanilla-coffee", "French Vanilla Coffee", 285, pic("coffe art.jpg"), "Aromatic",
  ...
  },
  {
    ...
    items: [
      item("momo-steamed-6", "Steamed Chicken Momo (6 pcs)", 180, pic("new momo1.jpg"), "Steamed",
          "Soft steamed chicken dumplings served with dipping sauce — juicy and tender."),
      item("momo-steamed-10", "Steamed Chicken Momo (10 pcs)", 280, pic("new momo4.jpg"), "Steamed",
      ...
      item("momo-fried-10", "Fried Chicken Momo (10 pcs)", 300, pic("new momo2.jpg"), "Fried",
          "Larger portion of crispy fried chicken momo with house dipping sauce."),
      item("momo-special", "Special Sauce Momo (10 pcs)", 320, pic("chicken momo.jpg"), "Special",
  ...
  },
  {
    ...
    items: [
      ...
      item("panipuri-regular-10", "Regular Panipuri (10 pcs)", 120, pic("new fuchka1.jpg"), "Regular",
      ...
      item("panipuri-spicy-10", "Extra Spicy Panipuri (10 pcs)", 160, pic("new fuchka 4.jpg"), "Spicy",
  ...
  },
  {
    ...
    items: [
      item("noodles-veg", "Veg Noodles", 220, pic("new noodles.jpg"), "Veg",
          "Stir-fried noodles tossed with mixed vegetables and savory sauce — light and tasty."),
      item("noodles-egg", "Egg Noodles", 240, pic("new noodles .jpg"), "Egg",
          "Stir-fried noodles with scrambled egg and seasonings — simple, savory, filling."),
      item("noodles-chicken", "Chicken Noodles", 280, pic("new noodles1.jpg"), "Chicken",
      ...
      item("noodles-mixed", "Special Mixed Noodles", 340, pic("noodles.jpg"), "Special",
  ...
  },
  {
    ...
    items: [
      item("fuchka-regular-6", "Regular Fuchka (6 pcs)", 70, pic("new fucka.jpg"), "Regular",
          "Crunchy fuchka shells with tangy tamarind water and mashed potato — burst of flavor."),
      item("fuchka-regular-10", "Regular Fuchka (10 pcs)", 110, pic("new fuchka5.jpg"), "Regular",
          "Larger portion of classic fuchka — crunchy, tangy, and refreshingly sour."),
      item("fuchka-special-10", "Special Fuchka (10 pcs)", 140, pic("new fuchka1.jpg"), "Special",
          "Special filling with extra chutney and spice — fuller, more flavorful punch."),
      item("fuchka-spicy-10", "Hot & Spicy Fuchka (10 pcs)", 150, pic("new fuchka 4.jpg"), "Spicy",
